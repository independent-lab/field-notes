...
<ArticleImage src="/images/cms-structured-responsibilities.webp" alt="A blue speech bubble above an orderly set of clipped paper modules for content, images, checks, dates and files" />
